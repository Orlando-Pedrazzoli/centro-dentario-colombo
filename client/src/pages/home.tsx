          ...
          <div className='max-w-3xl'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 md:gap-6 lg:gap-8 text-white'>
              ...
              >
                ...
                <span className='text-sm sm:text-base font-medium group-hover:text-blue-200 transition-colors flex-1'>
                  {t('hero.featureClinicalTeam')}
                </span>
                <svg
                  className='w-3 h-3 sm:w-4 sm:h-4 text-blue-300 opacity-60 group-hover:opacity-100 group-hover:translate-x-0.5 transition-all'
                  fill='none'
                  stroke='currentColor'
                  viewBox='0 0 24 24'
                >
              ...
              <div className='bg-gradient-to-r from-blue-600 to-blue-700 text-white p-6 rounded-xl shadow-lg mt-8'>
                <div className='flex items-start gap-4'>
                  ...
                  <div>
                    ...
                    <p className='text-blue-100'>{t('about.ersDesc')}</p>
                  </div>
                </div>
              </div>
            </div>
