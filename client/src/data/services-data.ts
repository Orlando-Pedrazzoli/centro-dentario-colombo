...
const treatmentsPT: Treatment[] = [
  {
    ...
    title: 'Cáries',
    slug: 'caries',
    subtitle: 'Dentisteria e Restaurações',
    description:
    ...
    fullContent: {
      ...
      additionalInfo:
        'Quando uma lesão se torna muito extensa, pode ser necessária a intervenção de outras especialidades como Endodontia, Prótese Fixa, Prótese Removível ou Implantologia para garantir o melhor resultado.',
    },
    bannerImage:
  ...
  },
  {
    ...
    description:
      'Recupere o seu sorriso, bem-estar e função mastigatória através das técnicas e tecnologias mais avançadas em reabilitação oral.',
    fullContent: {
      whatIs:
        'A Reabilitação Oral é uma abordagem multidisciplinar que visa restaurar completamente a função mastigatória, estética e estabilidade da cavidade oral. Esta especialidade é responsável pela substituição de dentes perdidos e recuperação de casos complexos que afetam múltiplos dentes. Cada tratamento é cuidadosamente avaliado caso-a-caso, envolvendo a integração de diversas áreas da Medicina Dentária como Implantologia, Ortodontia, Prótese Fixa e Removível, Estética Dentária e Periodontologia. O objetivo é criar um plano de tratamento personalizado que devolva não apenas a função, mas também a autoestima e qualidade de vida do paciente.',
      advantages: [
      ...
      additionalInfo:
        'No Centro Dentário Colombo, desenvolvemos planos de tratamento personalizados que combinam as mais modernas técnicas para garantir resultados duradouros e naturais.',
    },
    bannerImage:
      'https://images.unsplash.com/photo-1598256989800-fe5f95da9787?w=1200&h=600&fit=crop',
    image1:
      'https://images.unsplash.com/photo-1660732205525-eb180e4d29f8?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    image2:
  ...
  },
  {
    ...
    fullContent: {
      ...
      advantages: [
        ...
        'Prevenção de problemas na articulação temporomandibular (ATM)',
  ...
  },
  {
    ...
    fullContent: {
      ...
      additionalInfo:
        'Todos os procedimentos cirúrgicos são realizados com máximo conforto e segurança, utilizando técnicas modernas de anestesia e controlo de dor.',
    },
    bannerImage:
      'https://images.unsplash.com/photo-1579684453423-f84349ef60b0?w=1200&h=600&fit=crop',
    image1:
      'https://images.unsplash.com/photo-1598531228433-d9f0bdc5ab26?w=800&h=500&fit=crop',
    image2:
  ...
  },
  {
    ...
    description:
      'Observação, diagnóstico e tratamento especializado de lesões e patologias dos tecidos moles e duros da cavidade oral.',
    fullContent: {
      whatIs:
        'A Medicina Oral é a especialidade dedicada à prevenção, diagnóstico precoce e tratamento de patologias que afetam os tecidos moles (gengivas, mucosas, língua, lábios) e duros (dentes e ossos) da cavidade oral. Esta área tem papel fundamental na deteção de lesões suspeitas, sendo que quando necessário, pode ser realizada biópsia para obtenção de diagnóstico histológico preciso e avaliação do potencial maligno da lesão. A Medicina Oral também trata doenças das glândulas salivares, diagnostica e trata quistos e tumores da região maxilofacial, bem como lesões mais comuns como aftas, herpes labial, candidíase oral, entre outras. A vigilância regular e a atuação precoce são essenciais para prevenir o desenvolvimento de patologias graves.',
      advantages: [
      ...
      additionalInfo:
        'Qualquer lesão na boca que não cicatrize em 2 semanas, ou alteração persistente na cor ou textura dos tecidos orais, deve ser avaliada por um especialista em Medicina Oral.',
    },
    bannerImage:
      'https://distintasaude.pt/wp-content/uploads/2023/08/acordos-1024x566.jpg',
    image1:
  ...
  },
  {
    ...
    fullContent: {
      ...
      additionalInfo:
        'O tratamento oclusal frequentemente envolve o uso de goteiras (placas oclusais) personalizadas que protegem os dentes e relaxam a musculatura.',
    },
    bannerImage:
      'https://images.pexels.com/photos/5794074/pexels-photo-5794074.jpeg',
    image1:
      'https://images.unsplash.com/photo-1626736985932-c0df2ae07a2e?q=80&w=1331&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    image2:
      'https://brdental.com.br/wp-content/uploads/2022/07/O_que__a_ocluso_dentria_Saiba_como_cuidar.webp',
    keywords: [
      'oclusão',
      'ATM',
      'bruxismo',
  ...
  },
  {
    ...
    description:
      'Cuidado especializado e preventivo para a saúde oral de bebés, crianças e adolescentes num ambiente acolhedor.',
    fullContent: {
      whatIs:
  ...
  },
  {
    ...
    title: 'Ortodontia',
    slug: 'ortodontia',
    subtitle: 'Aparelhos Dentários e Alinhadores',
    description:
      'Corrija o posicionamento dos seus dentes com aparelhos convencionais ou transparentes invisíveis para um sorriso harmonioso.',
    fullContent: {
      whatIs:
      ...
      additionalInfo:
        'O tratamento ortodôntico pode ser realizado em qualquer idade, sendo cada vez mais comum em adultos que buscam melhorar seu sorriso e saúde oral.',
    },
    bannerImage:
  ...
  },
  {
    ...
    description:
      'Previna e trate doenças das gengivas. Evite sangramento, dor, mau hálito e a perda prematura de dentes.',
    fullContent: {
      whatIs:
...
const treatmentsEN: Treatment[] = [
  {
    ...
    fullContent: {
      ...
      additionalInfo:
        'When a lesion becomes too extensive, intervention from other specialties such as Endodontics, Fixed Prosthetics, Removable Prosthetics, or Implantology may be necessary to ensure the best outcome.',
    },
    bannerImage:
      'https://images.unsplash.com/photo-1743767587921-473b6d079137?q=80&w=1355&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    image1:
  ...
  },
  {
    ...
    fullContent: {
      ...
      additionalInfo:
        'At Centro Dentário Colombo, we develop personalized treatment plans that combine the most modern techniques to ensure lasting and natural results.',
    },
    bannerImage:
      'https://images.unsplash.com/photo-1598256989800-fe5f95da9787?w=1200&h=600&fit=crop',
    image1:
  ...
  },
  {
    ...
    fullContent: {
      ...
      additionalInfo:
        'We offer fixed prosthetics (crowns and bridges) that protect and cover damaged teeth, and removable prosthetics (acrylic or skeletal) that facilitate oral hygiene.',
    },
    bannerImage:
      'https://images.unsplash.com/photo-1612283105859-6e2585710acd?q=80&w=1224&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    image1:
  ...
  },
  {
    ...
    description:
      'Transform your smile through modern cosmetic treatments that restore beauty, naturalness, and confidence.',
    fullContent: {
      whatIs:
  ...
  },
  {
    ...
    fullContent: {
      ...
      additionalInfo:
        'All surgical procedures are performed with maximum comfort and safety, using modern anesthesia and pain control techniques.',
    },
    bannerImage:
      'https://images.unsplash.com/photo-1579684453423-f84349ef60b0?w=1200&h=600&fit=crop',
    image1:
  ...
  },
  {
    ...
    fullContent: {
      ...
      additionalInfo:
        'After endodontic treatment, it is essential to restore the tooth with an appropriate crown or reconstruction to ensure its longevity and function.',
    },
    bannerImage:
      'https://images.unsplash.com/photo-1658847075814-bf9a341c91e5?q=80&w=1287&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    image1:
  ...
  },
  {
    ...
    description:
      'Restore your smile with fixed teeth using advanced implant technology. Same-day teeth possibility!',
    fullContent: {
      whatIs:
      ...
      additionalInfo:
        'At Centro Dentário Colombo, we use cutting-edge technology that allows, in selected cases, teeth placement on the same day as implant surgery!',
    },
    bannerImage:
      'https://images.unsplash.com/photo-1660732205497-f284ab0be4e9?q=80&w=1125&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    image1:
  ...
  },
  {
    ...
    description:
      'Observation, diagnosis, and specialized treatment of lesions and pathologies of the soft and hard tissues of the oral cavity.',
    fullContent: {
      whatIs:
        'Oral Medicine is the specialty dedicated to prevention, early diagnosis, and treatment of pathologies affecting the soft tissues (gums, mucous membranes, tongue, lips) and hard tissues (teeth and bones) of the oral cavity. This area plays a fundamental role in detecting suspicious lesions, and when necessary, a biopsy can be performed for accurate histological diagnosis and assessment of the malignant potential of the lesion. Oral Medicine also treats diseases of the salivary glands, diagnoses and treats cysts and tumors of the maxillofacial region, as well as more common lesions such as canker sores, cold sores, oral candidiasis, among others. Regular surveillance and early action are essential to prevent the development of serious pathologies.',
      advantages: [
      ...
      additionalInfo:
        'Any mouth lesion that does not heal within 2 weeks, or persistent changes in the color or texture of oral tissues, should be evaluated by an Oral Medicine specialist.',
    },
    bannerImage:
      'https://distintasaude.pt/wp-content/uploads/2023/08/acordos-1024x566.jpg',
    image1:
  ...
  },
  {
    ...
    fullContent: {
      ...
      additionalInfo:
        'Occlusal treatment often involves the use of personalized splints (occlusal plates) that protect teeth and relax the muscles.',
    },
    bannerImage:
      'https://images.pexels.com/photos/5794074/pexels-photo-5794074.jpeg',
    image1:
  ...
  },
  {
    ...
    fullContent: {
      ...
      additionalInfo:
        'Orthodontic treatment can be performed at any age, being increasingly common in adults seeking to improve their smile and oral health.',
    },
    bannerImage:
      'https://images.unsplash.com/photo-1720685193942-5a1c5ac7fd80?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    image1:
